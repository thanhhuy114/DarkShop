...
class OrderUserDetail extends StatefulWidget {
  final Invoice invoice;
  const OrderUserDetail({Key? key, required this.invoice}) : super(key: key);

  @override
  OrderUserDetailState createState() => OrderUserDetailState();
}

class OrderUserDetailState extends State<OrderUserDetail> {
  @override
